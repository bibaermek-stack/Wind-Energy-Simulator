...
export const T = {
  ...
  absoluteNotMarked: 'Үш панель де 20 модуль, 51,67 m² — ватты тікелей салыстыру әділ',
  installedCapacity: 'Орнатылған қуат:',
  specificYieldNotice:
    'Үш панель де бірдей: 20 модуль, 51,67 m². Айырмашылық тек бағдарда, '
   ...
   * not. Only the fixed panel's ground frame is catalogue geometry; the
   * modules follow the standard module size, and the tracker's pole is
   * generated because the catalogue has no pole mount anywhere in it.
   */
  trackerMountNotice:
    'Үш панель де нақты өмірдегі өлшемде, жел турбиналары сияқты: әрқайсысында '
    + '20 заманауи модуль (2,28 × 1,13 m, 580 W, 144 жарты элемент), 11,5 × '
    + '4,6 m. Бекітілген панельдің жақтауы — берілген 3D каталогтан алынып, '
    + 'нақты 2P үстелдің тереңдігіне дейін үлкейтілген. '
    + 'Автотрекердің бағанасы, бұрылыс басы, көлденең білігі мен рельстері '
    + 'бөлек жасалды: каталогта бағаналы трекер жоқ еді. Модульдер бұрылыс '
    + 'осінен 0,6 m алда тұрады, сондықтан болат бөліктер әйнектің артында '
    + 'қалады.',
  ...
  compareThreeIntro:
    'Үш панель де 20 модуль, 51,67 m², бір күннің астында, бірдей аспан мен '
  ...
  solarExampleNotice:
    'Ескерту: панель ауданы (51,67 m²) мен өлшемдері нақты модуль '
    + 'өлшемінен (2,28 × 1,13 m) есептелген, ПӘК 22,5 % — 580 W модульге '
    + 'сәйкес. Қалған параметрлер (температуралық коэффициент, NOCT, '
