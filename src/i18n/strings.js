...
export const T = {
  ...
  absoluteNotMarked: 'Абсолют мәндер ауданға тәуелді — жеңімпаз тек m² бойынша белгіленеді',
  installedCapacity: 'Орнатылған қуат:',
  specificYieldNotice:
    'Үш панельдің ауданы әртүрлі (13,09 / 15,43 / 9,61 m²), сондықтан ваттарды '
    + 'тікелей салыстыру әділетсіз — үлкен панель жай ғана үлкен болғаны үшін '
    + 'көбірек береді. Меншікті қуат (W/m²) ауданды бөліп тастайды да, тек '
    + 'бағдардың әсерін қалдырады. Бағаналар осы мәнмен салынған.',
  ...
  compareThreeIntro:
    'Үш панель де бір мезгілде, бір күннің астында, бірдей аспан мен ауа '
    + 'райында жұмыс істейді. Электрлік параметрлері де бірдей. Жалғыз '
    + 'айырмашылық — бағдарын кім анықтайды: автоматика, пайдаланушы, '
    + 'әлде ешкім.',
  trackingGainThreeNote: 'Автотрекер бекітілген панельден артық (W/m² бойынша)',
