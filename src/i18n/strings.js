...
export const T = {
  ...
  absoluteNotMarked: 'Үш панель де 16 модуль, 26,14 m² — ватты тікелей салыстыру әділ',
  installedCapacity: 'Орнатылған қуат:',
  specificYieldNotice:
    'Үш панель де бірдей: 16 модуль, 26,14 m². Айырмашылық тек бағдарда, '
   ...
   */
  trackerMountNotice:
    'Үш панельде де бірдей 16 стандартты модуль (0,99 × 1,65 m, 60 элемент) '
    + 'бар. Бекітілген панельдің жақтауы — берілген 3D каталогтан алынған. '
    ...
    + 'осінен 0,48 m алда тұрады, сондықтан болат бөліктер әйнектің артында '
    + 'қалады.',
  ...
  compareThreeIntro:
    'Үш панель де 16 модуль, 26,14 m², бір күннің астында, бірдей аспан мен '
  ...
  solarExampleNotice:
    'Ескерту: панель ауданы (26,14 m²) мен өлшемдері стандартты модуль '
    + 'өлшемінен (0,99 × 1,65 m) есептелген. Қалған параметрлер (ПӘК, температуралық коэффициент, NOCT, '
